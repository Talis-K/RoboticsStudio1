...
def generate_launch_description():
    ...
    robot_spawner = Node(
        ...
        arguments=['-topic', '/robot_description', '-z', '0.7'] # z is height above ground
    )
    ...
    # # Launch odometry_listener
    # odometry_listener_node = Node(
    #     package='41068_ignition_bringup',
    #     executable='odometry_listener.py',
    #     name='odometry_listener',
    #     output='screen',
    #     parameters=[{'use_sim_time': use_sim_time}]
    # )
    # ld.add_action(odometry_listener_node)
